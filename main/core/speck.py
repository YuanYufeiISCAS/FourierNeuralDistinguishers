...
def make_train_data(n, nr, diff=(0x2800, 0x0010)):
    # 0010, 2000 for 6 rounds acc
    # 2800, 0010 for 8 rounds acc 0.513 (0.521)
...
def make_train_data_diff(n, nr, diff=(0x2800, 0x0010)):
    # 0010, 2000 for 6 rounds acc
...
def make_pos_data(n, nr, diff=(0x0040, 0000)):
    keys = np.frombuffer(urandom(8 * n), dtype=np.uint16).reshape(4, -1)
    plain0l = np.frombuffer(urandom(2 * n), dtype=np.uint16)
    plain0r = np.frombuffer(urandom(2 * n), dtype=np.uint16)
    plain1l = plain0l ^ diff[0]
...
def make_pos_data_diff(n, nr, diff=(0x0040, 0000)):
    keys = np.frombuffer(urandom(8 * n), dtype=np.uint16).reshape(4, -1)
    plain0l = np.frombuffer(urandom(2 * n), dtype=np.uint16)
    plain0r = np.frombuffer(urandom(2 * n), dtype=np.uint16)
    plain1l = plain0l ^ diff[0]
